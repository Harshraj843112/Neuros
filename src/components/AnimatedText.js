...
const AnimatedText = () => {
  return (
    <div className="relative h-28 mt-2 sm:mt-4 md:mt-4 lg:mt-[20rem] xl:mt-[20rem]">
      {/* Black background with left-to-right moving text */}
      <div
        className="bg-[#2E4168] h-20 flex items-center absolute top-[-40px] sm:top-[-96px] md:top-[-10px] lg:top-0 left-0 w-full"
        style={{
      ...
      <div
        className="bg-[#FF4C4C] h-20 flex items-center absolute top-[-130px] sm:top-[-200px] md:top-[-100px] lg:top-[-70px] xl:top-[-50px] left-0 w-full p-4"
        style={{
