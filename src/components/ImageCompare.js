...
const ImageSection = ({ title, beforeImage, afterImage }) => (
    <div className="w-full md:w-1/2 p-4 rounded-lg shadow-lg bg-white">
        <h2 className="text-center text-xl md:text-2xl font-semibold mb-4 text-blue-800" style={{ fontFamily: 'Poppins, sans-serif' }}>{title}</h2>
        <ReactCompareSlider
...
const ImageComparison = () => {
    return (
        <div className="container mx-auto p-6 lg:p-12 space-y-12 bg-white rounded-lg shadow-md">
            <h1 className="text-center text-3xl md:text-4xl font-extrabold mb-8 text-indigo-800 font-sans">
                Sample Prescription
            </h1>
            <p className="text-center mb-6 text-lg md:text-2xl text-gray-700 font-medium font-sans">
                <span className="text-indigo-600 font-semibold">Move the slider</span> left and right to see the magic!
            </p>
